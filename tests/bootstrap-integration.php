...
$newopm_wp_tests_dir = getenv('WP_TESTS_DIR') ?: '/tmp/wordpress-tests-lib';

if (! is_dir($newopm_wp_tests_dir)) {
    echo "\nERROR: WP test suite not found at {$newopm_wp_tests_dir}.\n";
    echo "Run bin/install-wp-tests.sh or set WP_TESTS_DIR.\n\n";
    exit(1);
}

define('NEWOPM_TESTS_DIR', dirname(__DIR__));
...
require_once $newopm_wp_tests_dir . '/includes/functions.php';

tests_add_filter('muplugins_loaded', static function (): void {
    require_once NEWOPM_TESTS_DIR . '/newopm.php';
});

require_once $newopm_wp_tests_dir . '/includes/bootstrap.php';
